...
We computed the Pearson correlation between the converted logits and our elastic net coefficients and found a correlation $r$ of `r bloem_cor$estimate %>% formatd(3)`, which again is significant. The correlation again shows an overlap between previous results and our results, despite differences in methodology. 
