...
It is immediately clear that a GAM model is much better at capturing patterns in the semantic space. We also see general semantic areas appearing, where the model predicts data points to generally be more red, more green or just 'neutral'. Still, if we look at the actual data points, the semantic space remains quite messy. Nonetheless, it seems that the GAM models are much better at dealing with semantic noise than the clustering algorithms.
