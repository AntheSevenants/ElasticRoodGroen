...
At the same time, our hollistic model brings CxG further than just breaking down the barrier between syntax and lexicon by introducing a method that takes the lexicon seriously. Indeed, much of the research around CxG stops at the assumption that (1) multiword patterns exist, against the atomic view of the lexicon consisting of just words) (2) syntactic constructions are partially filled with concrete lexical material (todo Israel article). Our study moves this goalpost by providing a technique that allows one to investigate the role of the lexicon in abstracte templates (TODO Freek vragen) (1) on a much bigger scale than in earlier, anecdotal research (TODO vb vragen) (2) on a highly quantitative level (3) under multifactorial control. As such, elastic net is an excellent tool for researchers interested lexical effects as part of a more elaborate and intensive CxG framework.
