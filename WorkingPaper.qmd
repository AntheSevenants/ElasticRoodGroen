...
```{r #tbl-hartigan}
#| fig-cap: "Overview of the results of the incremental Hartigan algorithm. When the Hartigan statistic drops below ten, it is no longer beneficial to add another cluster. Clusters are computed on full semantic vectors for all verbs with a non-zero coefficient"
