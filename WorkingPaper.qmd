...
For future research, it would be interesting to apply the elastic net technique to other morphosyntactic alternations, especially in other languages, in order to address several of the questions remaining around the technique and the post-analysis. In this way, we will learn more about how language users choose between equivalent variants, and in what way the lexicon contributes towards this choice.
