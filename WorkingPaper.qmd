...
For future research, it would be interesting to apply the elastic net technique to other morphosyntactic alternations, especially in other languages. Steps in this regard have already been taken [artikel Alexandra, Yi]. In this way, we will learn more about how language users choose between equivalent variants, and how different influences relate to each other.
