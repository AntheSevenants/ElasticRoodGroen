...
This alternance is also possible in main clauses with three or more verbs, but it is best known in subordinate clauses. Crucially, a difference in word order does not appear to entail a difference in meaning [@bloem_processing_2021, 2]. In the following sections, we give an overview of how the three lines of research detailed in the introduction treat this variation.
