...
In both @de_sutter_rood_2005 and @bloem_processing_2021 we find several other factors which also contribute to the choice between red and green: length of the middle field, syntactic depth, information value, definiteness, extraposition and inherence (collocations and multi-word units). We will not treat these influences for two reasons. Firstly, the measured effects for these influences are small compared to the influences we discussed above. This brings us to our second, more pragmatic reason: scope. The focus of this study is to find out whether the *lexical* dimension has influence the choice between the red and green order. The other predictors are merely included to provide multifactorial control. A further operationalisation of a plethora of smaller effects would detract from the main goal of the study, and would foray into the area of diminishing returns as well.
...
other_coefficients$feature <- gsub("(aux)", "auxiliary", other_coefficients$feature)
